        ...
        <div className="shadow-sm border-2 border-[#772E3F] dark:border-[#FA8B5F] bg-white dark:bg-black hover:scale-105 hover:bg-[#f0e1e5] transition-all dark:hover:bg-[#252437] dark:bg-opacity-30">
            ...
            <div className="px-4">
                <div className="mb-4 flex justify-between items-center">
                    ...
                    <button
                        className="flex items-center gap-2 text-sm bg-[#772E3F] dark:bg-[#FA8B5F] text-white px-4 py-1 rounded-lg hover:bg-[#FA705F] transition duration-200 dark:hover:bg-[#9f4f44]"
